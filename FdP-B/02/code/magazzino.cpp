...
public:
    ...
    Magazzino(const Magazzino& other) {
...
void testMagazzino(){
    cout << endl << " ==== Test classe Magazzino<Prodotto> ==== " << endl;
    
    Magazzino<Prodotto> m1(5);

    cout << endl << " ==== Test enlarge ==== " << endl;

    for(int i = 0; i < 10; i++){
        Prodotto p(i, "Prodotto " + i, 10, 10);
        m1.add(p);
    }

    cout << endl << " ==== Test remove ==== " << endl;
    Prodotto p(5, "Prodotto 5", 10, 10);
    cout << "Size prima della remove: " << m1.getSize() << endl;
    cout << m1.remove(p) << endl;
    cout << "Size dopo la remove: " << m1.getSize() << endl;

    cout << endl << " ==== Test contains ==== " << endl;
    Prodotto p2(9, "Prodotto 9", 10, 10);
    cout << (m1.contains(p2) ? "E' presente" : "Non è presente")  << endl;

    cout << endl << " ==== Test costruttore di copia ==== " << endl;
    Magazzino<Prodotto> m2 = m1;
    cout << "Size m1: " << m1.getSize() << endl;
    cout << "Size m2: " << m2.getSize() << endl;

    cout << endl << " ==== Test operatore di assegnamento ==== " << endl;
    Magazzino<Prodotto> m3(5);
    m3 = m1;
    cout << "Size m1: " << m1.getSize() << endl;
    cout << "Size m3: " << m3.getSize() << endl;

    cout << endl << " ==== Fine Test classe Magazzino<Prodotto> ==== " << endl;
}
